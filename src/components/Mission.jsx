...
import "./mv.css";
import AboutStats from "./credible";
    ...
    <section className="about-content">
      ...
      <div className="about-story">
        <div className="story-container">
          ...
          <p>
            Operating with a client-first philosophy, Bima Shelter Ltd prides itself on maintaining transparency, ethical standards, 
            and a responsive approach in all its dealings. Every project is approached with a sense of responsibility-to clients, communities, and the environment. The company is also committed to sustainable development practices, ensuring that its projects align with contemporary environmental standards and contribute positively to urban growth.
          </p>
