...
import "./comstyle.css";
import {
  Trees, ShieldCheck, Footprints, Zap, ParkingCircle, Fence,
  X, CheckCircle, Loader, ChevronLeft, ChevronRight
} from "lucide-react";
...
import img6 from "../assets/images/proper/parkvillaI1.jpg";
import img7 from "../assets/images/proper/parkvillaI2.jpg";
import img8 from "../assets/images/proper/parkvillaI3.jpg";
...
const galleryImages = [img1, img7, img5, img6, img3, img8];
...
const InterestModal = ({ onClose, onSuccess }) => {
  ...
  return (
    <div
      ...
      role="dialog" aria-modal="true" aria-labelledby="ri-modal-title"
      onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}
    >
      <div className="ri-modal">
        <div className="ri-modal__header">
          <div>
            <p className="ri-modal__eyebrow">Exclusive Opportunity</p>
    ...
    <div className="parkvilla">
      ...
      <section className="pv-overview container fade-in">
        ...
        <p className="pv-overview__body">
          ...
          blending contemporary design with timeless luxury. Designed for those who demand
          the extraordinary, Park Villa offers complete privacy, generous living spaces,
          and world-class finishing within a secure, landscaped enclave.
        </p>
      </section>
      ...
      <section className="pv-cta" ref={ctaRef}>
        <div className="pv-cta__inner">
          <p className="pv-cta__eyebrow">Limited to 6 Units</p>
          <h2 className="pv-cta__heading">Register Your Interest</h2>
          <p className="pv-cta__sub">
            Secure your place in one of Maitama's most exclusive addresses.
      ...
      {/* ── MODAL ── */}
      {showModal && (
        <InterestModal onClose={closeModal} onSuccess={handleSuccess} />
      )}

      {/* ── SUCCESS TOAST ── */}
      {showToast && (
        <SuccessToast onDismiss={() => setShowToast(false)} />
      )}
    </div>
  );
};
