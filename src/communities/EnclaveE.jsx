...
import "./comstyle.css";
import { ShieldCheck, Route, Car, Droplets, Zap, Footprints, Trees, X, CheckCircle, Loader, ChevronLeft, ChevronRight} from "lucide-react";
import img1 from "../assets/images/proper/ECestate1.jpg";
import img2 from "../assets/images/proper/ECestate2.jpg";
import img3 from "../assets/images/proper/ECestate3.jpg";
import img4 from "../assets/images/proper/ECestate4.jpg";
import img5 from "../assets/images/proper/ECestate5.jpg";
import img6 from "../assets/images/proper/ECestate6.jpg";

/* ─── DATA ─── */

const amenities = [
 {Icon: ShieldCheck, label: "Security",desc: "24/7 controlled access with professional estate management"},
 {Icon: Route, label: "Good Road Network", desc: "Well-laid and fully accessible internal road system" },
 {Icon: Car, label: "Ample Parking", desc: "Spacious parking areas for residents and visitors" },
 {Icon: Droplets, label: "Water Supply", desc: "Reliable and consistent water provision across all units"},
 {Icon: Zap, label: "Backup Electricity", desc: "Dedicated power backup ensuring uninterrupted living"},
 {Icon: Footprints, label: "Walking Paths", desc: "Well-designed pedestrian walkways for leisure and movement"},
 {Icon: Trees, label: "Children’s Playground", desc: "Secure outdoor play areas within a landscaped environment"}
];
    ...
    onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="ri-modal">
        <div className="ri-modal__header">
          <div>
            <p className="ri-modal__eyebrow">Enclave Estate · Apo, Abuja</p>
...
const EnclaveEstate = () => {
  ...
  return (
    <div className="parkvilla">
      ...
      {/* HERO */}
      <section className="pv-hero" style={{ backgroundImage: `url(${img4})` }}>
        <div className="pv-hero__overlay" />
        <div className="pv-hero__content">
          <p className="pv-hero__eyebrow">Asoskoro · Abuja</p>
          <h1 className="pv-hero__title">Enclave </h1>
          <p className="pv-hero__tagline">Luxurios Villas</p>
        </div>
      ...
      <section className="pv-overview container fade-in">
        ...
        <h2 className="pv-overview__heading">Ultra-Exclusive Villa Living in Prime Asokoro</h2>
        <p className="pv-overview__body">
          Enclave Estate is a refined, low-density luxury development located at Plot 417,
          Cadastral Zone A04, in the heart of Asokoro District, Abuja — one of the most
          prestigious and secure residential enclaves in the Federal Capital Territory.
          Designed for exclusivity and comfort, the estate comprises just 42 units of
          fully detached 7-bedroom villas, offering expansive living spaces, privacy,
          and a serene environment for high-net-worth residents. With a well-structured
          internal road network, reliable water supply, dedicated backup electricity,
          and thoughtfully integrated lifestyle features such as walking paths and a
          children’s playground, Enclave Estate delivers a complete and elevated living
          experience. Its prime Asokoro location ensures close proximity to key
          government institutions, diplomatic zones, and the Abuja city centre, making
          it an exceptional choice for residents seeking both prestige and convenience.
        </p>         
      </section>
    ...
    <section className="pv-cta" ref={ctaRef}> 
      <div className="pv-cta__inner"> 
        <p className="pv-cta__eyebrow">42 Units</p> 
        <h2 className="pv-cta__heading">Register Your Interest</h2> 
        <p className="pv-cta__sub"> Secure your place in one of Asokoro's most exclusive addresses. Our team will be in touch within 24 hours. </p> 
        <button className="pv-cta__btn" onClick={openModal}> Register Interest </button> 
        </div> 
        </section>

     {/* ── STICKY BAR ── */} {showSticky && ( <div className="pv-sticky-cta"> <span className="pv-sticky-cta__name">Enclave Esate</span> <button className="pv-sticky-cta__btn" onClick={openModal}> Register Interest </button> </div> )} {/* ── MODAL ── */} {showModal && ( <InterestModal onClose={closeModal} onSuccess={handleSuccess} /> )} {/* ── SUCCESS TOAST ── */} {showToast && ( <SuccessToast onDismiss={() => setShowToast(false)} /> )} </div> ); };

export default EnclaveEstate;